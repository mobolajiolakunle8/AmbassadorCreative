              ...
              <button
                onClick={() => {
                  window.dispatchEvent(new CustomEvent('open-share-modal', {
                    detail: { id: selectedProject.id, name: selectedProject.name, color: selectedProject.color }
                  }));
                }}
                  ...
                  <img
                    ...
                    onError={e => {
                      ...
                      if (parent && !parent.querySelector('.img-fallback')) {
                        ...
                        fallback.className = 'img-fallback flex flex-col items-center justify-center py-16 text-gray-400';
                        fallback.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg><p class="text-xs mt-2">Image preview unavailable</p>';
